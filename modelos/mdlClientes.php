...
class ModeloCliente{
    public static function mdlGuardarCliente($tabla,$data){
        ...
        (cedula,nombre,apelidos,direccion,telefono,email)
        VALUES (:cedula,:nombre,:apelidos,:direccion,:telefono,:email)");
        $stm->bindParam(':cedula',$data['cedula'],PDO::PARAM_STR);
        $stm->bindParam(':nombre',$data['nombre'],PDO::PARAM_STR);
        $stm->bindParam(':apelidos',$data['apelidos'],PDO::PARAM_STR);
